...
- [Depth camera obstacle-only (known geometry)](docs/plan/camera_floor_known_geometry.md): delete floor calibration/LUTs; compute geometry on startup; unknown depth has no costmap contribution.
