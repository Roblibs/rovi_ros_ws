...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ROBOTMODELCHUNK']._serialized_end=921
  _globals['_UIBRIDGE']._serialized_start=924
  _globals['_UIBRIDGE']._serialized_end=1324
